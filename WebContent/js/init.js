	...
	var color = {
	"ICD": d3.scale.ordinal().domain(["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX","XXI","XXII",""]).range(["#fff5f0","#fee0d2","#fcbba1","#fc9272","#fb6a4a","#ef3b2c","#cb181d","#fff5eb","#fee6ce","#fdd0a2","#fdae6b","#fd8d3c","#f16913"]),
